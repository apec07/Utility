...
public class Utility {
	...
	public static void writeLogger()throws SecurityException, IOException {
	// write to path	
		Logger log1 = Logger.getLogger("log-Test");
        
    FileHandler fileHandler = new FileHandler("d:/testLog%g.log",true);
    ...
    log1.severe("warning級別打印：severe級別日誌信息");
